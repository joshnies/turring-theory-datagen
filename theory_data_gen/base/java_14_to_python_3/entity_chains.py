...
from .lvp import gen_java_provided_generics
...
def __gen_entity(mask_token_args_only=False):
    ...
    # Generate generics
    src_generics = gen_java_provided_generics() if is_func_call else ''

    # Generate final output
    source = f'{MASK_TOKEN}{src_generics}{func_call_markers[0]}{source_args}{func_call_markers[1]}'
    target = f'{MASK_TOKEN}{func_call_markers[0]}{target_args}{func_call_markers[1]}'
